            ...
            <div class="th-widget-about">
                ...
                <div class="info-box">
                    ...
                    <h5 class="info-box_text">
                        <a href="tel:+11278956825" class="info-box_link">+212 5228-31616</a>
                    </h5>
                </div>
                <div class="info-box">
                    <p class="info-box_title">
...
<div class="th-menu-wrapper">
    <div class="th-menu-area text-center">
        ...
        <div class="th-mobile-menu">
            <ul>
                <li>
                    <a href="<?php echo $path; ?>">Accueil</a>
                </li>
        ...
        <div class="container">
            <div class="row justify-content-center justify-content-lg-between align-items-center gy-2">
                ...
                <div class="col-auto d-none d-lg-block">
                    <div class="header-links social-links">
                        <ul>
                            <li>
                            ...
                            <li>
                                <a href="https://www.pinterest.com/">Pintarest</a>
                            </li>
                            <li>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <div class="header-logo">
                            <a href="<?php echo $path; ?>"><img src="<?php echo $path; ?>/assets/img/logo_light.png" alt="Privilège" style="height:75px"></a>
                        </div>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="header-button d-flex d-lg-none">
                            ...
                            <button type="button" class="icon-btn th-menu-toggle"><i class="far fa-bars"></i></button>
                        </div>
                    </div>
