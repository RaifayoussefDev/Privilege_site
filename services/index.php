...
<!--==============================
    Breadcumb
==============================-->
<div class="breadcumb-wrapper" data-bg-src="<?php echo $path; ?>/assets/img/Photos/889A9532-HDR.jpg">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-lg-block d-none align-self-end">
                <div class="breadcumb-thumb">
                    <img src="<?php echo $path; ?>/assets/img/Photos/889A9577.jpg" alt="Privilège Fitness" style="max-height:320px;object-fit:cover;border-radius:8px;">
                </div>
            </div>
        </div>
    </div>
